                            ...
                            <form wire:submit.prevent="updateProduct">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    @foreach ($productImages as $item)
                                        <img src="{{asset('assets/imgs/products')}}/{{$item->image}}" width="100px" height="100px" alt="">
                                        <a href="#" wire:click.prevent="deleteImage({{$item->id}})"><i class="fa fa-times text-danger me-2"></i></a>
                                    @endforeach
                                    @error('images')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
