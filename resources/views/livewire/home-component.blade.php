                        ...
                        @foreach ($nproducts as $nproduct)
                            <div class="product-cart-wrap small hover-up">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{route('product.details', ['slug' => $nproduct->slug])}}">
                                            @php
                                                $imageFirst = App\Models\ProductImages::where('product_slug', $nproduct->slug)->take(1)->get();
                                                $imageSecond = App\Models\ProductImages::where('product_slug', $nproduct->slug)->skip(1)->take(1)->get();
                                            @endphp
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-price">
                                        @if ($nproduct->sale_price != NULL)
                                            <span>Rp.{{ number_format($nproduct->sale_price,2,',','.')}} </span>
                                            <span class="old-price">Rp.{{ number_format($nproduct->regular_price,2,',','.')}}</span>
                                        @else
                                            <span>Rp.{{ number_format($nproduct->regular_price,2,',','.')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
